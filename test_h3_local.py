...
class LocalH3Generator:
    """ローカルでH3見出しを生成するクラス（API不要）"""
    
    def __init__(self):
        # キーワードカテゴリの定義
        self.categories = {
            "product_service": {
                "indicators": ["おすすめ", "比較", "ランキング", "選び方", "購入"],
                "h3_templates": {
                    "h2_1": "基本情報",
                    "h3_1": [
                        "基本的な仕組みと効果",
            ...
            "knowledge": {
                "indicators": ["効果", "メリット", "デメリット", "とは", "意味"],
                "h3_templates": {
                    "h2_1": "基本概念",
                    "h3_1": [
                        "基本的な定義と仕組み",
...
def test_local_h3_generation():
    """ローカルH3生成のテスト"""
    print("=== ローカルH3生成テスト（API不要） ===")
